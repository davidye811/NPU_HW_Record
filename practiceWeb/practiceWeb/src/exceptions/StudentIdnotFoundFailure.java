...
public class StudentIdnotFoundFailure extends Exception {
		...
		public StudentIdnotFoundFailure(int failureReason) {
			this.failureReason = failureReason;
		}
		
		public StudentIdnotFoundFailure(int failureReason, String msg) {
			super(msg);
			this.failureReason = failureReason;
		}
