...
public class BusAppDataSource {
	...
	public static DataSource setupDataSource() {
        ...
        dataSrc = new org.apache.commons.dbcp.BasicDataSource();
	...
	private static Properties loadJdbcProperties() {
		...
		try {
			...
			jdbcPropStrm = BusAppDataSource.class.getClassLoader().getResourceAsStream("jdbc_config.properties");
